...
ut, here is some exceptions, when usage of short date allowed.  
...
<span>$19.99/6 months</span>

Other formats are wrong, such as "price per period", "price for period".  
<span>$19.99 per Year</span>  
<span>$19.99 for year</span>

### Price per Unit and Period
The valid format is "price/unit per period".
<span >$19.99/GB per month</span>  

Other formats are wrong.  
<span>$19.99/GB/Month</span>    
<span>$19.99 per GB per Month</span>
