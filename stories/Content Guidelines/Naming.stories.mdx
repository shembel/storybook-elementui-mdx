import CBButton from '../Components/Basic/CBButton/CBButton'
import { Meta  } from '@storybook/addon-docs/blocks';

<Meta title="Content Guidelines/Naming" component={CBButton}/>
...
Use brief but meaningful text that explains what happens after the users clicks this CBButton.  
