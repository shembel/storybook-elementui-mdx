...
<!-- ![](4.1-Bad.png?sizes=427px) -->

<!-- <span style="color:green">:fa-check-circle-o:</span> -->
Use [Actions button](/ui-kit/controls/button/actions) to gather together all functions available.  
<!-- ![](4.1-Good.png?sizes=363px) -->


Prev: [Design Process](?path=/docs/principal-design-process--page)
