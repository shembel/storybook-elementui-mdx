...
1. [Design Process](?path=/docs/principal-design-process--page)
 - Consistency First. But not for the sake of the very consistency.
2. [Communication with User](?path=/docs/principal-communication-with-user--page)
...
3. [Organization of Information](?path=/docs/principal-organization-of-information--page)
